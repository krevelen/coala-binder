/* $Id: aaf52531844beb90835586bd69cee93818fec8fa $
 * 
 * @license
 ...
 * 
 * @version $Id: aaf52531844beb90835586bd69cee93818fec8fa $
...
public class TreatmentBuilder extends Treatment
{
	...
	private static final Logger LOG = LogUtil
			.getLogger( TreatmentBuilder.class );
	...
	{
		return (String) (getProperties() == null ? null
	...
	public TreatmentBuilder withProperty( final String key, final String value )
	{
		...
		if( properties == null ) setProperties( new Properties() );
	...
	{
		return withStartTime( interval.getStart() )
				.withRunLength( interval.toDuration() );
	}

	public TreatmentBuilder withRunLength( final Duration runLength )
	{
		final TimeUnitInterface toTimeUnit = getTimeUnit();
		return withRunLength(
				DsolUtil.toTimeUnit( toTimeUnit, runLength.getMillis(),
	...
	{
		final TimeUnitInterface toTimeUnit = getTimeUnit();
		return withWarmupPeriod(
				DsolUtil.toTimeUnit( toTimeUnit, warmupPeriod.getMillis(),
						TimeUnitInterface.MILLISECOND ).doubleValue() );
	}
