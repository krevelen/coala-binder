 ...
 */
public class JSAReasoningCapability extends BasicCapability
	implements ReasoningCapability//<KBase>
{
	...
	{
		FORMULA( Formula.class ), TERM( Term.class ), AGENTID( Term.class ),;
	...
	protected JSAReasoningCapability( final Binder binder )
	{
		...
		kbase = new FilterKBaseImpl(
				new ArrayListKBaseImpl(
						JSA.getTermForAgentID( (getBinder().getID()) ) ),
	...
	public static Formula getFormulaForObject( Object javaObject,
		Map<String, Object> keyValuePairs ) throws Exception
	{
		return getSLForObject( Formula.class, javaObject,
				toParameters( keyValuePairs ) );
	}

	public static Term getTermForObject( Object javaObject,
		Map<String, Object> keyValuePairs ) throws Exception
	{
		return getSLForObject( Term.class, javaObject,
				toParameters( keyValuePairs ) );
	}
	 ...
	 * @throws Exception
	 */
	public static Term getTermForObject( Object javaObject, Object... params )
		throws Exception
	{
		return getSLForObject( Term.class, javaObject, params );
	}

	public static Formula unparsedTextNodeFormula = SL
			.formula( "(unparsedString ??string)" );

	public void addNodeToKBase( final Object javaObject,
		final Object... params )
	{
		try
		{
			getKBase()
					.assertFormula( getFormulaForObject( javaObject, params ) );
		} catch( Exception e )
		{
			CoalaExceptionFactory.VALUE_NOT_ALLOWED.create(
					"Could not instantiate and assert SL formula.", javaObject,
					params, e );
		}
	}

	public void retractNodeFromKBase( final Object javaObject,
		final Object... params )
	{
		try
		{
			getKBase().retractFormula(
					getFormulaForObject( javaObject, params ) );
		} catch( Exception e )
		{
			CoalaExceptionFactory.VALUE_NOT_ALLOWED.create(
					"Could not instantiate and retract SL formula.", javaObject,
					params, e );
		}
	}
	 ...
	 * @return
	 */
	public Observable<Map<String, Object>>
		queryToKBase( final Object javaObject, final Object... params )
	{

		if( javaObject == null ) throw new NullPointerException(
				"A query must always be about something, querying null is not possible." );
		...
		try
		{
			query = JSAReasoningCapability.getFormulaForObject( javaObject,
					params );
		} catch( Exception e1 )
		{
					...
					while( it.hasNext() )
					{
						...
						for( int i = 0; i < mr.size(); i++ )
						{
							...
							if( strVal.startsWith( "\"" )
									&& strVal.endsWith( "\"" ) )
								next.put( SL.getMetaReferenceName( var ), strVal
										.substring( 1, strVal.length() - 1 ) );
							else
				...
				result.subscribe( new rx.Observer<Map<String, Object>>()
				{
					...
					private void removeSubscriptionAndObserver()
					{
						...
						if( s != null )
						{
							...
							getKBase().removeObserver(
									observers.get( javaObject ) );
							observers.remove( javaObject );
							log.trace( "Removed observer for "
									+ javaObject.toString() );
						} else
						{
							log.warn( "Failed to cleanup observer for "
									+ javaObject.toString() );
						}
					}
	...
	public static <T extends Node> T getSLForObject( Class<T> slNodeType,
		Object javaObject, Map<String, Object> keyValuePairs ) throws Exception
	{
		return getSLForObject( slNodeType, javaObject,
				toParameters( keyValuePairs ) );
	}

	@SuppressWarnings( "unchecked" )
	public static <T extends Node> T getSLForObject( Class<T> slNodeType,
		Object javaObject, Object... params ) throws Exception
	{
		if( javaObject == null ) throw new NullPointerException(
				"Can not instantiate null object." );
		T node;
		if( javaObject instanceof SLConvertible )
		{
			node = ((SLConvertible<?>) javaObject).toSL();
		} else if( javaObject instanceof SLParsable
				|| javaObject instanceof Node )
		{
			LOG.trace( "Parsing SL parsable string" + javaObject );
			node = JSA.instantiateAsSL( slNodeType, javaObject );
			if( params.length % 2 != 0 ) throw new Exception(
					"Invalid amount of paramters, expected key value pairs" );
			String key = null;
			Node value = null;
	...
	@Override
	public Query toQuery( Object javaObject, Object... params )
	{
		try
		{
		...
		{
			log.warn( "The String: \"" + javaObject
	...
	@Override
	public Belief toBelief( Object javaObject,
	...
	@Override
	public Query toQuery( Object javaObject, Map<String, Object> keyValuePairs )
	{
