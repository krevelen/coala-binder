/* $Id: f690e1a0cddff98d922848c9e03a8f2d86721eab $
* 
 * @license
 ...
 * <p>
 * See also 1) {@link ToolProvider#getSystemJavaCompiler()} with example
 * <a href="http://www.rgagnon.com/javadetails/java-0039.html">here</a> (since
 * 1.6), 2) a custom {@link ClassLoader} with hints <a href=
 * "http://stackoverflow.com/questions/15512740/generating-dynamic-class-java" >
 * here</a> (since 1.0) or 3) Java's Dynamic {@link Proxy} with example <a href=
 * "http://javahowto.blogspot.nl/2011/12/java-dynamic-proxy-example.html" >here
 * </a> (since 1.3). Forget about Java's innate <a href=
 * "http://www.technobits.net/articles/46024/java-synthetic-class-method-field/"
 * >synthetic class/method/field</a>
 * 
 * <p>
 * for builder generators see
 * <a href="https://github.com/mkarneim/pojobuilder">pojobuilder</a>, <a href=
...
public class DynaBeanTest
{
	...
	public void testDynaBeans() throws Exception
	{
		...
		LOG.trace(
				"Filtered employees: " + JsonUtil.toPrettyJSON( employees ) );
	}
