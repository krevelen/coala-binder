/* $Id: d9d9d55fdfebddf1a08afca7516265bf908ba776 $
...
public class ConfigTest {
	 ...
	 *
	 */
	@Sources({ "file:~/.myapp.config", "file:${user.home}/etc/myapp.config", "classpath:foo/bar/baz.properties" })
	...
	public void testOwnerAPI() throws Exception {
		...
		LOG.trace("Server " + cfg1.hostname() + ":" + cfg1.port() + " will run " + cfg1.maxThreads());

		final TestConfig cfg2 = ConfigCache.getOrCreate(TestConfig.class, props);
		LOG.trace("Server " + cfg2.hostname() + ":" + cfg2.port() + " will run " + cfg2.maxThreads());
	}
