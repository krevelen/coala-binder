...
public enum HttpMethod
{
	 ...
	 * <blockquote> The GET method means retrieve whatever information (in the
	 ...
	 * process, unless that text happens to be the output of the
	 * process. </blockquote>
	 */
	GET,
	 ...
	 * <a href="http://www.ietf.org/rfc/rfc2616.txt">RFC2616</a>:
	 * <blockquote> The HEAD method is identical to GET except that the server
	 ...
	 * method can be used for obtaining metainformation about the entity implied
	 * by the request without transferring the entity-body itself. This method
	 * is often used for testing hypertext links for validity, accessibility,
	 ...
	 * <a href="http://www.ietf.org/rfc/rfc2616.txt">RFC2616</a>:
	 * <blockquote> The POST method is used to request that the origin server
	 ...
	 * <a href="http://www.ietf.org/rfc/rfc2616.txt">RFC2616</a>:
	 * <blockquote> The PUT method requests that the enclosed entity be stored
	 ...
	 * version of the one residing on the origin server. </blockquote>
	 */
	PUT,
	 ...
	 * <a href="http://www.ietf.org/rfc/rfc2616.txt">RFC2616</a>:
	 * <blockquote> The TRACE method is used to invoke a remote,
	 * application-layer loop- back of the request message. The final recipient
	 * of the request SHOULD reflect the message received back to the client as
	 * the entity-body of a 200 (OK) response. The final recipient is either the
	 ...
	 * resource identified by the Request-URI. [...] The client cannot be
	 ...
	 * <a href="http://www.ietf.org/rfc/rfc2616.txt">RFC2616</a>:
	 * <blockquote> The OPTIONS method represents a request for information
